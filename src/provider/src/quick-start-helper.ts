...
export const displayQuickStartInfo = () => {
  ...
  if (!isLocalDev || nodeEnv === 'production') return;
  ...
  console.log('   Password: see the local test directory seed/configuration');
  console.log('   ⚠️  WARNING: Development-only credentials. Never reuse them in production!');
